...
/********************************** 用户需要设置的参数**********************************/
#define      macUser_ESP8266_ApSsid                       "Dainter"                //要连接的热点的名称
#define      macUser_ESP8266_ApPwd                        "QEERTYUIOP"           //要连接的热点的密钥

#define      macUser_ESP8266_TcpServer_IP                 "192.168.1.102"      //要连接的服务器的 IP
#define      macUser_ESP8266_TcpServer_Port               "5000"               //要连接的服务器的端口
